            ...
            <section className=' flex flex-col justify-start px-10 md:px-36 py-14 ' >
                <div className='flex-col justify-content-flex-start'>
                    ...
                    <div className="overflow-x-auto">
                        <div className="flex gap-x-24 px-4 py-2">
                            {/* Mac */}
                            <div className="flex flex-col items-center justify-between space-y-8 bg-white p-4 rounded-lg transition-transform duration-300 hover:-translate-y-2 hover:scale-105 hover:shadow-lg min-w-[160px]">
                                <img src="/assets/mac.png" alt="Mac" className=" h-[400px]  md:h-[200px] object-contain" />
