        ...
        <form>
          <div className=" max-w-md space-y-6">
            ...
            <div className="relative">
              {/* SVG Icon */}
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="absolute size-5 left-5 top-1/2 transform -translate-y-1/2 text-black">
              ...
              <input
                ...
                className="bg-white shadow-[0_4px_6px_rgba(194,106,13,0.8)] px-12 py-4 w-full rounded-lg focus:outline-none focus:ring-2 focus:ring-[#202020]/20 font-poppins placeholder-black"
              />
            </div>
        ...
        <div className="flex-1 space-y-6">
          ...
          <div className="grid grid-cols-3 gap-3 mb-4">
            {Object.keys(device_type).map((d) => (
              <div
                ...
                className={`cursor-pointer text-center px-4 py-4 shadow-[0_4px_6px_rgba(194,106,13,0.8)] rounded-lg border ${device === d
                  ? "bg-[#3f3f3f] text-white"
                  : "bg-white hover:bg-blue-100 text-black border-gray-300"
                  }`}
          ...
          {device && (
            <select
              ...
              className="bg-white shadow-[0_4px_6px_rgba(194,106,13,0.8)] px-4 py-4 w-full rounded-lg focus:outline-none focus:ring-2 focus:ring-[#202020]/20 font-poppins"
            >
